...
function CreateArticle() {
    ...
    const handleSubmit = (e) => {
        ...
        if(user == null){
            ...
            axios.post("https://iamimmortal8.pythonanywhere.com/createarticle/",form)
            .then((res) => {
                navigate("/")
                alert("success")
            })
        ...
        <div className="container">
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <input name='user' type="file" className="form-control"  />
                </div>
                  ...
                  <button className ="btn btn-dark btn-md w-100">Submit Article</button>
